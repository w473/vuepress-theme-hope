  ...
  setup(props, { slots }) {
    ...
    return (): VNode =>
      h("div", { class: "code-demo-wrapper", id: props.id }, [
        h(
          "div",
          { ref: demoWrapper, class: "demo-wrapper" },
          h("div", { class: "code-demo-app" })
        ),
        h(
          "div",
          { class: "code-wrapper", style: { height: `${height.value}px` } },
          h(
            "div",
            {
              ref: codeContainer,
        ...
        h("div", { class: "code-demo-footer" }, [
          h("button", {
            class: ["toggle-button", { expanded: isExpanded.value }],
            onClick: () => {
              height.value = isExpanded.value
                ? 0
                : // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
                  codeContainer.value!.clientHeight + 13.8;
            },
          }),
          props.title ? h("span", { class: "title" }, props.title) : null,
